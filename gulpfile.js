...
gulp.task('package', (cb) => {
    ...
    targetPkgJson['main'] = `bundles/ng2-awesome-disqus.umd.js`;
...
gulp.task('bundle', () => {
    ...
    const rollupGenerateOptions = {
        ...
        moduleId: '',
        moduleName: 'ng2AwesomeDisqus', //require for 'umd' bundling, must be a valid js identifier, see rollup/rollup/issues/584
        format: 'umd',
        globals,
        dest: 'ng2-awesome-disqus.umd.js'
    };
...
// Link 'dist' folder (create a local 'ng2-awesome-disqus' package that symlinks to it)
// This way, we can have the demo project declare a dependency on 'ng2-awesome-disqus' (as it should)
// and, thanks to 'npm link ng2-awesome-disqus' on demo project, be sure to always use the latest built
