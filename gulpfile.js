...
gulp.task('package', (cb) => {
    ...
    targetPkgJson['main'] = `bundles/ngx-disqus.umd.js`;
...
gulp.task('bundle', () => {
    ...
    const rollupGenerateOptions = {
        ...
        moduleId: '',
        moduleName: 'ngxDisqus', //require for 'umd' bundling, must be a valid js identifier, see rollup/rollup/issues/584
        format: 'umd',
        globals,
        dest: 'ngx-disqus.umd.js'
    };
...
// Link 'dist' folder (create a local 'ngx-disqus' package that symlinks to it)
// This way, we can have the demo project declare a dependency on 'ngx-disqus' (as it should)
// and, thanks to 'npm link ngx-disqus' on demo project, be sure to always use the latest built
