...
gulp.task('serve:demo', ()=>{
  return execDemoCmd('serve', { cwd: `${config.demoDir}`});
});

gulp.task('build:demo', ()=>{
  return execDemoCmd(`build --prod --aot --build-optimizer --base-href ngx-disqus`, { cwd: `${config.demoDir}`});
});
